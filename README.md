<h1 align="center">Hi 👋, I'm Mrigank Mishra</h1>
...
📍 Based in India | | 📧 Email: `mishrmrigank786@gmail.com`
...
| 🔧 Project | ⚡ Description |
|-----------|----------------|
| [`M_Pin-Checker`](https://github.com/selfishbro12/M_Pin-Checker) | A Python tool that analyzes how predictable or weak your mobile PIN is. |
| [`Google Translator GUI`](https://github.com/selfishbro12/Google-Translator) | Tkinter-based GUI for translating across languages using the Google Translate API. |
| [`Gender & Emotion Classifier`](https://github.com/selfishbro12/Gender-And-Emotion-Classifier) | Deep learning model that predicts gender, age, and emotion from webcam input. |
| [`Internet Speed Test`](https://github.com/selfishbro12/Internet-Speed-Test) | Lightweight Python speed tester using just the standard library. |
| [`Voice Assistant`](https://github.com/selfishbro12/Voice-Assistant) | A minimalist CLI-based voice assistant written purely in Python. |
| [`Currency Converter`](https://github.com/selfishbro12/Currency-Converter) | CLI tool to convert between currencies using live exchange rates. |
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=selfishbro12l&show_icons=true&theme=tokyonight&count_private=true" />
  <br/>
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=selfishbro12&theme=tokyonight" />
</p>
...
![visitors](https://komarev.com/ghpvc/?username=selfishbro12&label=PROFILE+VIEWS)
